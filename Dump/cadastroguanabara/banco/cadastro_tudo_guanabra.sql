...
--
-- Host: 127.0.0.1
-- Generation Time: 31-Maio-2016 às 00:10
...
-- Database: `cadastro`
--
CREATE DATABASE IF NOT EXISTS `cadastro1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cadastro1`;
...
(29, 'php6', 'Curso de PHP, versão 7.0', 40, 20, 2020),
...
(21, 'Ana Carolina Mendes', 'Ator', '2000-12-15', 'F', '83.30', '1.54', 'Brasil'),
